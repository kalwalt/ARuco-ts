...
const dstLegacy = new ImageLegacy(WIDTH, HEIGHT, new Array(WIDTH * HEIGHT).fill(0));
const timeLegacyThresh = benchmark('Legacy', () => {
...
const timeOptimizedThresh = benchmark('Optimized', () => {
...
// Legacy
const blurDstLegacy = new ImageLegacy(WIDTH, HEIGHT, new Array(WIDTH * HEIGHT).fill(0));
const timeLegacyBlur = benchmark('Legacy', () => {
...
const timeOptimizedBlur = benchmark('Optimized', () => {
...
const timeLegacyCanvas = benchmark('Legacy (with Array copy)', () => {
...
// Optimized: zero-copy
const timeOptimizedCanvas = benchmark('Optimized (zero-copy)', () => {
...
const timeLegacyPipeline = benchmark('Legacy', () => {
...
const timeOptimizedPipeline = benchmark('Optimized', () => {
...
// Legacy
const timeLegacyCount = benchmark('Legacy', () => {
    CVLegacy.countNonZero(dstLegacy, square);
}, { iterations: ITERATIONS });

// Optimized
const timeOptimizedCount = benchmark('Optimized', () => {
...
const avgSpeedup = (speedupGray + speedupThresh + speedupBlur + speedupCanvas + speedupPipeline + speedupCount) / 6;
